    ...
    return (
        <>
            <svg id="curveUpColor" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100" viewBox="0 0 100 100" className='mt-5' preserveAspectRatio="none">
                <path d="M0 100 C 20 0 50 0 100 100 Z" className='dark-accent-fill p-1' />
            </svg>
            <footer className='d-flex flex-column justify-content-center align-items-center light-shades mb-0'>
                ...
                <Container className='mt-2 mb-0 text-center'>
                    <p className='mb-1'>
